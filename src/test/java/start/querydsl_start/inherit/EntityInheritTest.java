package start.querydsl_start.inherit;
...
import start.querydsl_start.inherit.concreate.Kia;
import start.querydsl_start.inherit.concreate.Porsche;
import start.querydsl_start.inherit.join.Book;
import start.querydsl_start.inherit.join.Item;
import start.querydsl_start.inherit.join.Movie;
import start.querydsl_start.inherit.single.Galaxy;
import start.querydsl_start.inherit.single.IPhone;
import start.querydsl_start.inherit.single.Phone;
import start.querydsl_start.inherit.superclass.Buyer;
import start.querydsl_start.inherit.superclass.Seller;
