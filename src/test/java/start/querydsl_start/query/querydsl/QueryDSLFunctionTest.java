...
public class QueryDSLFunctionTest {
    ...
    @Test
    @DisplayName("QueryDSL-[SQL 내장함수-Expressions] 테스트")
    @Transactional
    @Rollback(false)
    void testQuertDSL_Expressions()
    {
        //WHERE
    ...
    @Test
    @DisplayName("QueryDSL-[SQL 내장함수] 테스트")
    @Transactional
    @Rollback(false)
    void testQuertDSL_EmbededFunc()
    {
        //WHERE
        QTrader t = QTrader.trader;
